...
class TransactionSet:
	...
	def to_json(self) -> Dict[str, Any]:
		"""Convert the EDI 835 transaction set to JSON - delegates to object-based method"""
		return self.to_json_using_objects()
	
	def to_json_using_objects(self) -> Dict[str, Any]:
		"""Convert the EDI 835 transaction set to JSON using parsed objects instead of re-parsing file"""
		# Import the mixins to ensure they're applied
		...
		return {
			"interchange": {
				"ISA": self.interchange.to_dict() if self.interchange and hasattr(self.interchange, 'to_dict') else None,
				"GS": None,
				"transactions": [
					{
						"ST": {
							"transaction_set_identifier_code": "835",
							"transaction_set_control_number": "1234"  # You may want to extract this from parsed data
						},
						"BPR": self.financial_information.to_dict() if self.financial_information and hasattr(self.financial_information, 'to_dict') else None,
						"TRN": self.trace.to_dict() if self.trace and hasattr(self.trace, 'to_dict') else None,
